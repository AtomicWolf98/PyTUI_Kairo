...
from tests_v2.support.fakes import FakeKernel
...
async def test_thought_is_separate_and_collapsed() -> None:
    from kairo_tui_v2.widgets.message import split_thought
...
async def test_plan_card_is_structured() -> None:
    from kairo_tui_v2.reducer import PlanCardUpdated, fold_event
...
async def test_session_switch_keeps_transcripts_separate() -> None:
    from kairo_tui_v2.reducer import TranscriptMerged

...
from kairo_tui.state import SessionView, TurnView, WorkspaceView
...
class TuiController:
    ...
    async def load_history(self, session_id: SessionId) -> list[UiAction]:
        ...
        from kairo_tui.reducer import TranscriptReplaced
    ...
    async def load_workspace(self) -> list[UiAction]:
        from kairo_tui.reducer import WorkspaceUpdated
    ...
    async def create_session(self, name: str) -> list[UiAction]:
        from kairo_tui.reducer import NoticeSet, SessionActivated, SessionsLoaded
    ...
    async def rename_session(self, session_id: object, name: str) -> list[UiAction]:
        from kairo_tui.reducer import NoticeSet, SessionsLoaded
    ...
    async def execute_command(self, name: str) -> list[UiAction]:
        from kairo_tui.reducer import NoticeSet
    ...
    async def select_model(self, profile_id: object) -> list[UiAction]:
        ...
        from kairo_tui.reducer import NoticeSet, ProfileUpdated
